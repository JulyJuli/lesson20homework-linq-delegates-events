...
namespace HW20._1
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                var cars = new Car(Convert.ToString((CarModels)carModel.Next(1, 10)), yearOfCar.Next(1990, 2020), new WashingCard(cardMoney.Next(0, 200), new DateTime(dataTimeYear.Next(2019, 2020), dataTimeMonth.Next(1, 12), dataTimeDay.Next(1, 30))));
                carsList.Add(cars);
            }
            ...
            for (int i = 0; i < countStation; i++)
            {
                washingStations[i].CarWashProcess(carsList);
                Console.WriteLine("\n/////////////////////////////////////////////////////////////////////////////////////////////////////\n");
            }
        }
    }
